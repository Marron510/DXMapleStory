...
ADawn::ADawn()
{
...

	{
		...
		Dawn_Sky->SetSprite("04_DawnImage", 0);
...

	{
		...
		Dawn_Moon_LeftUp->SetSprite("04_DawnImage", 1);
		Dawn_Moon_LeftUp->SetupAttachment(RootComponent);
		Dawn_Moon_LeftUp->SetScale3D({ 812.0f , 618.0f });
		Dawn_Moon_LeftUp->SetRelativeLocation({ -360.0f, -20.0f });
	}

	{
		std::shared_ptr<class USpriteRenderer> Dawn_Moon_CenterUp = CreateDefaultSubObject<USpriteRenderer>();
		Dawn_Moon_CenterUp->SetSprite("04_DawnImage", 2);
		Dawn_Moon_CenterUp->SetupAttachment(RootComponent);
		Dawn_Moon_CenterUp->SetScale3D({ 600.0f , 450.0f });
		Dawn_Moon_CenterUp->SetRelativeLocation({ 20.0f, 220.0f });
	}

	{
		std::shared_ptr<class USpriteRenderer> Dawn_Cloud_CenterBack = CreateDefaultSubObject<USpriteRenderer>();
		Dawn_Cloud_CenterBack->SetSprite("04_DawnImage", 15);
...

	{
		...
		Dawn_Moon_RightMid->SetSprite("04_DawnImage", 2);
		Dawn_Moon_RightMid->SetupAttachment(RootComponent);
		Dawn_Moon_RightMid->SetScale3D({ 600.0f , 450.0f });
		Dawn_Moon_RightMid->SetRelativeLocation({ 300.0f, -50.0f });
	}

	{
		std::shared_ptr<class USpriteRenderer> Dawn_Castle = CreateDefaultSubObject<USpriteRenderer>();
		Dawn_Castle->SetSprite("04_DawnImage", 4);
		Dawn_Castle->SetupAttachment(RootComponent);
		Dawn_Castle->SetScale3D({ 584.0f , 78.0f });
...

	{
		...
		Dawn_Cloud_LeftBottomBack->SetSprite("04_DawnImage", 5);
...

	{
		...
		Dawn_Cloud_LeftCenter->SetSprite("04_DawnImage", 6);
		Dawn_Cloud_LeftCenter->SetupAttachment(RootComponent);
		Dawn_Cloud_LeftCenter->SetScale3D({ 484.0f , 210.0f });
...

	{
		...
		Dawn_Cloud_RightUP->SetSprite("04_DawnImage", 6);
		Dawn_Cloud_RightUP->SetupAttachment(RootComponent);
		Dawn_Cloud_RightUP->SetScale3D({ 484.0f , 210.0f });
...

	{
		...
		Dawn_Cloud_RightBack->SetSprite("04_DawnImage", 8);
...

	{
		...
		Dawn_Cloud_LeftBot->SetSprite("04_DawnImage", 7);
...

	{
		...
		Dawn_Cloud_RightBot->SetSprite("04_DawnImage", 7);
		Dawn_Cloud_RightBot->SetupAttachment(RootComponent);
		Dawn_Cloud_RightBot->SetScale3D({ 1116.0f , 466.0f });
	...
	}
	{
		...
		Dawn_Cliff1->SetSprite("04_DawnImage", 9);
...

	{
		...
		Dawn_Cliff2->SetSprite("04_DawnImage", 10);
...

	{
		...
		Dawn_Floor->SetSprite("04_DawnImage", 11);
...

	{
		...
		Dawn_Stone1->SetSprite("04_DawnImage", 12);
...

	{
		...
		Dawn_Stone2->SetSprite("04_DawnImage", 13);
...

	{
		...
		Dawn_Fog_BottomLeft->SetSprite("04_DawnImage", 14);
...

	{
		...
		Dawn_Fog_BottomRight->SetSprite("04_DawnImage", 14);
