	...
	if (true == ThreadLoadingInit)
	{
		...
		if (true == ThreadLoadingEnd)
		{
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Skill/UnicornSpikeHit");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Skill/RollingMoonSultHit");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Skill/StrikeDualShotBall");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Skill/StrikeDualShotHit");
...
#pragma region
		...
		#pragma endregion
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Seren/Phase1_Laser");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Skill/Phase1_8Laser");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Skill/Phase1_FloorSkill");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Skill/Small_Atom_Start");
...

			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Skill/Small_Atom_Ing");
			...
			
			{
				...
				Dir.Append("Image");
				Dir.Append("Phase1");
				Dir.Append("Phase1_Skill/Small_Atom_End");
