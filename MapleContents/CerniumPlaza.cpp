...
ACerniumPlaza::ACerniumPlaza()
{
...

	{
		...
		Plaza_Front->SetRelativeLocation({ MapSizeHalfX, -390.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::BackGround_Front)});
	}

	{
		...
		Plaza_Mid->SetRelativeLocation({ MapSizeHalfX, -390.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::BackGround_Mid) });
	}

	{
		...
		Plaza_Back->SetRelativeLocation({ MapSizeHalfX, -390.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::BackGround_Back) });
	}
	...
	// 깃발
	{
		...
		Flag0->SetRelativeLocation({ -334.0f + MapSizeHalfX, 374.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Object_Front) });
	}
	{
		...
		Flag1->SetRelativeLocation({ -800.0f + MapSizeHalfX, 484.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Object_Front) });
	}

	{
		...
		Flag2->SetRelativeLocation({ -1302.0f + MapSizeHalfX, 638.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
...

	{
		...
		Flag3->SetRelativeLocation({ 364.0f + MapSizeHalfX, 374.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
	{
		...
		Flag4->SetRelativeLocation({ 840.0f + MapSizeHalfX, 484.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}

	{
		...
		Flag5->SetRelativeLocation({ 1328.0f + MapSizeHalfX, 638.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Object_Front) });
	}
...

	{
		...
		Smithy->SetRelativeLocation({ -1100.0f + MapSizeHalfX, -130.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Back) });
	}

	{
		...
		BuildingLeft_0->SetRelativeLocation({ -1370 + MapSizeHalfX, -150.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Building_Mid3) });
	}
	
	{
		...
		BuildingLeft_1->SetRelativeLocation({ -1850 + MapSizeHalfX, -333.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Mid2)});
	}
...

	{
		...
		Potion->SetRelativeLocation({ 1160.0f + MapSizeHalfX, -130.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Back) });
	}

	{
		...
		BuildingRight_0->SetRelativeLocation({ 1400.0f + MapSizeHalfX, -150.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Mid3) });
	}

	{
		...
		BuildingRight_1->SetRelativeLocation({ 1830 + MapSizeHalfX, -310.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Mid2) });
	}
...

	{
		...
		Tree_0->SetRelativeLocation({ -1860.0f + MapSizeHalfX, -182.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		Tree_1->SetRelativeLocation({ 1890.0f + MapSizeHalfX, -182.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		DawnPriestFlag->SetRelativeLocation({ -1700.0f + MapSizeHalfX, -182.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		FirePriestFlag->SetRelativeLocation({ 1700.0f + MapSizeHalfX, -182.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		FootHold_Left_0->SetRelativeLocation({ 422.0f + MapSizeHalfX, 255.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Left_1->SetRelativeLocation({ 818.0f + MapSizeHalfX, 405.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Mid->SetRelativeLocation({ 954.0f + MapSizeHalfX, 404.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Right->SetRelativeLocation({ -782.0f + MapSizeHalfX, 405.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		BigTree_Left->SetRelativeLocation({ -2180.0f + MapSizeHalfX, -420.0f - MapSizeHalfY - 408.0f , static_cast<float>(EMapleZEnum::Front_Object3) });
	}

	{
		...
		BigTree_Right->SetRelativeLocation({ 2200.0f + MapSizeHalfX, -420.0f - MapSizeHalfY - 408.0f, static_cast<float>(EMapleZEnum::Front_Object3) });
	}
