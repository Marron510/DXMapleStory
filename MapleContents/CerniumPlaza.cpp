...
ACerniumPlaza::ACerniumPlaza()
{
...

	{
		...
		Plaza_Front->SetRelativeLocation({ 0.0f, -390.0f, static_cast<float>(EMapleZEnum::BackGround_Front)});
	}

	{
		...
		Plaza_Mid->SetRelativeLocation({ 0.0f, -390.0f, static_cast<float>(EMapleZEnum::BackGround_Mid) });
	}
	...
	// 깃발
	{
		...
		Flag0->SetRelativeLocation({ -334.0f, 374.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
	{
		...
		Flag1->SetRelativeLocation({ -800.0f, 484.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}

	{
		...
		Flag2->SetRelativeLocation({ -1302.0f, 638.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
...

	{
		...
		Flag3->SetRelativeLocation({ 364.0f, 374.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
	{
		...
		Flag4->SetRelativeLocation({ 840.0f, 484.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}

	{
		...
		Flag5->SetRelativeLocation({ 1328.0f, 638.0f , static_cast<float>(EMapleZEnum::Object_Front) });
	}
...

	{
		...
		Smithy->SetRelativeLocation({ -1100.0f, -130.0f , static_cast<float>(EMapleZEnum::Building_Back) });
	}

	{
		...
		BuildingLeft_0->SetRelativeLocation({ -1370, -150 , static_cast<float>(EMapleZEnum::Building_Mid3) });
	}
	
	{
		...
		BuildingLeft_1->SetRelativeLocation({ -1850, -333 , static_cast<float>(EMapleZEnum::Building_Mid2)});
	}
...

	{
		...
		Potion->SetRelativeLocation({ 1160.0f, -130.0f , static_cast<float>(EMapleZEnum::Building_Back) });
	}

	{
		...
		BuildingRight_0->SetRelativeLocation({ 1400, -150 , static_cast<float>(EMapleZEnum::Building_Mid3) });
	}

	{
		...
		BuildingRight_1->SetRelativeLocation({ 1830, -310 , static_cast<float>(EMapleZEnum::Building_Mid2) });
	}
...

	{
		...
		Tree_0->SetRelativeLocation({ -1860, -182 , static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		Tree_1->SetRelativeLocation({ 1890, -182 , static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		DawnPriestFlag->SetRelativeLocation({ -1700, -182 , static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		FirePriestFlag->SetRelativeLocation({ 1700, -182, static_cast<float>(EMapleZEnum::Building_Mid1) });
	}

	{
		...
		FootHold_Left_0->SetRelativeLocation({ 422, 255 , static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Left_1->SetRelativeLocation({ 818, 405 , static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Mid->SetRelativeLocation({ 954, 404 , static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		FootHold_Right->SetRelativeLocation({ -782, 405, static_cast<float>(EMapleZEnum::Front_Object1) });
	}

	{
		...
		BigTree_Left->SetRelativeLocation({ -2180, -420 , static_cast<float>(EMapleZEnum::Front_Object3) });
	}
